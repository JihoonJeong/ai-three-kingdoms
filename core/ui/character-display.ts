...
const EXPRESSION_MAP: Record<string, Record<string, Expression>> = {
  ...
  huangzhong:  { default: 'default', expr1: 'determined', expr2: 'angry', expr3: 'tired' },
  weiyuan:     { default: 'default', expr1: 'ambitious', expr2: 'angry', expr3: 'displeased' },
  jianyong:    { default: 'default', expr1: 'smile', expr2: 'worried', expr3: 'thinking' },
  caocao:      { default: 'default', expr1: 'sneer', expr2: 'angry', expr3: 'arrogant' },
  xiahouyuan:  { default: 'default', expr1: 'charge', expr2: 'angry', expr3: 'alert' },
  caoren:      { default: 'default', expr1: 'defend', expr2: 'determined', expr3: 'alert' },
  caimao:      { default: 'default', expr1: 'nervous', expr2: 'scheming', expr3: 'fearful' },
  zhangyun:    { default: 'default', expr1: 'nervous', expr2: 'determined', expr3: 'fearful' },
  sunquan:     { default: 'default', expr1: 'decisive', expr2: 'contemplating', expr3: 'majestic' },
  zhouyu:      { default: 'default', expr1: 'confident', expr2: 'angry', expr3: 'strategic' },
};
